            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <select
                  value={role}
                  onChange={(e) => setRole(e.target.value as UserRole)}
                  className="w-full px-4 py-3.5 bg-blue-100 border border-white rounded-xl text-black placeholder-black/60 focus:ring-2 focus:ring-blue-400 focus:border-transparent backdrop-blur-sm transition-all duration-200 hover:bg-blue-200/25"
                >
                  <option value="FACULTY" className="text-gray-900">Faculty Member</option>
                  <option value="HOD" className="text-gray-900">HOD</option>
                  <option value="DIRECTOR" className="text-gray-900">Director</option>
